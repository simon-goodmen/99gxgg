    ...
    return (
      <div className="profile-page">
        ...
        <div className="settings-body">
          ...
          <div style={{ textAlign: 'center', color: '#999', fontSize: '12px', marginTop: '20px' }}>版本号: v1.1.2</div>
      ...
      <div className="profile-content">
        {isLoggedIn ? (
          ...
          <div className="guest-content-lock">
            ...
            <p>登录后即可发布采购需求、</p>
            <p>管理项目底账及查看精益节省明细</p>
            <div style={{ textAlign: 'center', color: '#999', fontSize: '12px', marginTop: '40px' }}>版本号: v1.1.2</div>
          </div>
        )}
      </div>
